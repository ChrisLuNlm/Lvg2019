...
public class StripToken
{
    ...
    * </ul>
    * No overlap is allowed between restoreD, strippingD, and strippableD.
    *
    * @param   inStr  a String to be tokenized
    *
    * @return  a collection (Vector) of StrTokenObject of tokenized elements
    */
    ...
    *          if it's previous token is not stripped out.
    *
    * @return  a collection (Vector) of StrTokenObject - tokenized elements
    */
    public static Vector<StrTokenObject> Tokenize(String inStr, String restoreD,
    ...
    *
    * @return  a collection (Vector) of StrTokenObject - tokenized 
    *             StrTokenObject without any bad end character at the end.
    *
    * @see    StrTokenObject
    */
    ...
    *
    * @param   list  a collection of StrTokenObject
    *
    ...
    */
    ...
    // data member
    private final static StrTokenObject SPACE_DELIM = 
