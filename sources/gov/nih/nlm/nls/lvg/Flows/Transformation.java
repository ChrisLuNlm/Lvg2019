...
public abstract class Transformation
{
    ...
    */
    public final static int UPDATE = -1;    // flag used for update Cat & Infl
    /** A global definition for no mutation information */
    public final static String NO_MUTATE_INFO = 
        "none" + GlobalBehavior.GetInstance().GetFieldSeparator();
}
