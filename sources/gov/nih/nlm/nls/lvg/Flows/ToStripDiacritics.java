    ...
    */
        ...
        Hashtable<Character, Character> diacriticMap)
    {
        ...
        else    // use unicode normalization NFD algorithm
        {
            ...
            String inCharStr = Character.toString(inChar);
            String normStr = Normalizer2.getNFDInstance().normalize(inCharStr);
    ...
    */
        ...
        boolean detailsFlag, boolean mutateFlag)
    {
        ...
        for(int i = 0; i < inStr.length(); i++)
        {
            ...
            {
                // get the UniCode normalized String 
                String curCharStr = Character.toString(curChar);
                String normStr = Normalizer2.getNFDInstance().normalize(
                    curCharStr);
                // remove diacritics in Combinging diacritics Marks
                if((normStr.length() > 1)
    ...
    // data members
    private final static String INFO = "Strip Diacritics";
    private final static String NO_OPERATION = "NO"; 
    private final static String MAPPING = "MP"; 
    private final static String NORM_NFD = "NFD"; 
}
