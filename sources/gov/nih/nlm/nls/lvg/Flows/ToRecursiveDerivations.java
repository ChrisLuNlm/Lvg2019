...
public class ToRecursiveDerivations extends Transformation implements Cloneable
{
    ...
    */
    ...
    {
        ToRecursiveDerivations toRecursiveDerivations 
            = new ToRecursiveDerivations();
        // Mutate: 
        toRecursiveDerivations.Init(in.GetSourceTerm());
        toRecursiveDerivations.GetRecursiveDerivations(in, conn, trie, 
            restrictFlag, derivationType,
    ...
    * @see OutputFilter
    */
    private Vector<LexItem> GetDerivations(LexItem in, Connection conn,
        RamTrie trie, int restrictFlag, int derivationType,
    ...
    private void GetRecursiveDerivations(LexItem in, Connection conn,
        RamTrie trie, int restrictFlag, int derivationType, 
    ...
    private void CalRecursiveDerivations(LexItem in, Connection conn,
        RamTrie trie, int restrictFlag, int derivationType, 
        int derivationNegation, String infoStr, boolean topLevel, 
        boolean detailsFlag, boolean mutateFlag, String rFlowHistory)
    {
    ...
    private void Init(String inputTerm)
    {
    ...
    private void UpdateFlowHistory(boolean detailFlowFlag)
    {
    ...
    private Vector<LexItem> GetDerivationVector()
    {
        return derivations_;
    }
    // data members
    private final static String INFO = "Recursive Derivation";
    private Vector<LexItem> derivations_ = new Vector<LexItem>();
    private Hashtable<TermCatCatKey, LexItem> derivationHt_ 
        = new Hashtable<TermCatCatKey, LexItem>();
    private String orgInputTerm_ = new String();
}
