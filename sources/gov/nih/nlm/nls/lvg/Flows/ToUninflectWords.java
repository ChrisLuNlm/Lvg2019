...
public class ToUninflectWords extends Transformation
{
    ...
    * @param   maxTerm   the max. no of result terms
    ...
    * The input is a Vector of Vector of String - inList. 
    ...
    * multi-words term.
    *
    * @param   inList is a Vector of Vector of String - uninflected term 
    *             for each word in a term.
    *
    * @return  A Vector of String - all permutation results from input.
    */
    ...
    */
    ...
    // data members
    private final static String INFO = "Uninflect Words";
}
