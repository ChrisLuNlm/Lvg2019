...
public class ToInflection extends Transformation implements Cloneable
{
    ...
    * @param   trie   LVG Ram trie for inflection
    * @param   restrictFlag   a numerical flag to filter the output.  It's 
    * values are defined in OutputFilter as: LVG_ONLY, LVG_OR_ALL, ALL. 
    ...
    * @param   detailsFlag   a boolean flag for processing details information
    * @param   mutateFlag   a boolean flag for processing mutate information
    * @param   flowName   the abbreviation of this flow component for history
    *
    ...
    */
    ...
    // private methods
    // data members
    private final static String INFO = "Inflection";
}
