...
public class LexItem 
{
    ...
    *
    * @param term term of LexIterm
    * @param cat category in Long format
    * @param infl inflection in Long format
    */
    ...
    *
    * @param in input LexItem
    * @param allFlag boolean flag for copying from input LexItem
    */
    ...
    *
    * @param  tars  Vector of LexItem of the outputs of a flow component 
    *         and to be changed as the inputs for next flow component.
    *
    * @return  Vector of LexItem for the inputs of a flow component
    */
