...
public class OutputFilter
{
    ...
    *
    * @return  Vector of LexItems with inflection values less than 256.  
    *          An empty Vector is returned if no such LexItem exist.  
    */
    ...
    * @param  ins  a vector of LexItems to be simplified
    *
    * @return  Vector of LexItems with inflection values less than 
    ...
    */
    ...
    /** Enumerated type for synonym source */
    public final static int S_SRC_ALL = 0;  // all sources: default
    public final static int S_SRC_CUI = 1;      // same cui in meta-thesaurus
    public final static int S_SRC_EUI = 2;      // eui: Lexicon nominalization
    public final static int S_SRC_NLP = 3;      // nlp: lvg synonyms + nlp 
    public final static int S_SRC_CUI_EUI = 4;  // cui and eui
    public final static int S_SRC_CUI_NLP = 5;  // cui and nlp
    public final static int S_SRC_EUI_NLP = 6;  // eui and nlp
    // private data member
