...
public class LexItemComparator<T> implements Comparator<T>
{
    ...
    */
    ...
    private final static int[] CAT_PRIORITY = new int[Category.TOTAL_BITS];
    static
    {
        CAT_PRIORITY[Category.NOUN_BIT] = 1;
        CAT_PRIORITY[Category.ADJ_BIT] = 2;
        CAT_PRIORITY[Category.VERB_BIT] = 3;
        CAT_PRIORITY[Category.ADV_BIT] = 4;
        CAT_PRIORITY[Category.PREP_BIT] = 5;
        CAT_PRIORITY[Category.PRON_BIT] = 6;
        CAT_PRIORITY[Category.CONJ_BIT] = 7;
        CAT_PRIORITY[Category.DET_BIT] = 8;
        CAT_PRIORITY[Category.MODAL_BIT] = 9;
        CAT_PRIORITY[Category.AUX_BIT] = 10;
        CAT_PRIORITY[Category.COMPL_BIT] = 11;
    }
}
