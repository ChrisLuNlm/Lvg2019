...
final public class PersistentTrieTree
{
    ...
    *
    * @param triePath the path of trie file
    * @param rulePath the path of rules
    * @param exceptionPath the path of exceptions
    */
    ...
    * tree.
    * 
    * @param   inFile  the input rule flat file: inflection or derivation. 
    * 
