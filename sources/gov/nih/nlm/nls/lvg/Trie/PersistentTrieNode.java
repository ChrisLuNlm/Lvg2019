...
public class PersistentTrieNode extends PersistentTreeNode
{
    ...
    * access file.
    *
    * @param   address address of current trie node
    */
    ...
    *
    * @param   key of current trie node
    * @param   ruleAddress address of current trie node
    */
    ...
    * persistent tree.
    *
    * @param level level of current persistent tree node at a tire tree
    ...
    * @param child child of current persistent tree node at a trie tree
    * @param address address in a random access file.
    */
    ...
    *
    * @return persistent tree node at the specified address of RAF
    * @exception   IOException  if problems happen when accessing the random
    * access file.
    */
