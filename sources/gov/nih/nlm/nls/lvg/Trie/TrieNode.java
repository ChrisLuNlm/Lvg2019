...
public class TrieNode
{
    ...
    *
    * @param key key of current tree node
    * @param level level of current tree node
    */
    ...
    * @param key key of current tree node
    * @param level level of current tree node
    * @param rule a vector of InflectionRule - rule of current node
    * @param child a vector of TrieNode - child of current node
    */
    ...
    // public methods
    /**
    * Set the child of the current node.  The child is Vector of TrieNode.
    *
    ...
    */
    ...
    /**
    * Set rules of the current node.  The rules is a Vector of InflectionRule.
    *
    ...
    */
    ...
    /**
    * Get rules of the current node.  The rules is a Vector of InflectionRule.
    *
    ...
    */
    ...
    /**
    * Get the child of the current node.  The child is a Vector of TrieNode.
    *
