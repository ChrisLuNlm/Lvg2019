...
public class PersistentRuleNode extends PersistentListNode
{
    ...
    *
    * @param ruleStr rule instring format.
    * @param exceptionAddress the exception adddress of current node.
    */
    ...
    *
    * @return the persistent list node of specified address in RAF
    *
