...
final public class RamTrie
{
    ...
    * suffix in the entire tree.
    *
    * @return  a collection (Vector) of RuleResult of uninflected terms
    */
    ...
    * @param inInfl  input inflections
    *
    * @return  a collection (Vector) of CatInfl, categories and inflections, 
    * from rules
    */
    ...
    * suffix in the entire tree.
    *
    * @return  a collection (Vector) of RuleResult of inflected terms
    */
    ...
    * suffix in the entire tree.
    *
    * @return  a collection (Vector) of RuleResult of derivations
    */
    ...
    * <br> &lt; term &gt;: input term for testing
    * <br> &lt; -i &gt;: mutate with all branch rules applied
    * <br> &lt; -p &gt;: print details, rule, and exceptions
    * <br> &lt; -s &gt;: mutate with all branch rules applied
    *
