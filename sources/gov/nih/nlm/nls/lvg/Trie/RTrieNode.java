...
public class RTrieNode
{
    ...
    * @param  level of the current node
    */
    ...
    * @param  key of current trie node
    * @param  level of the current node
    * @param  child of the current node
    */
    ...
    // public methods
    /**
    * Set the child of the current node.  The child is a Vector of RTrieNode.
    *
    ...
    */
    ...
    /**
    * Get the child of the current node.  The child is Vector of RTrieNode. 
    *
