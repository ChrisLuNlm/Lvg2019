...
public class PersistentExceptionNode extends PersistentListNode
{
    ...
    *
    * @param  address   the address of current persistent exception node
    */
    ...
    *
    * @param  address   the address of current persistent exception node
    * @param  next   address of the next node of current node
    */
    ...
    *
    * @return persistent list node for the specified address in RAF
    * 
