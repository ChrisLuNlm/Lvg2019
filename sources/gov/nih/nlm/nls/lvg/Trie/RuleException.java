...
public class RuleException
{
    ...
    *
    * @param exceptionStr exception string for rules, key|value
    */
    ...
    */
    ...
    private void DecomposeExceptionStr()
    {
        ...
        {
            System.err.println("** Err@RuleException.DecomposeExceptionStr( ): Wrong format in RuleException(" + exceptionStr_ + ")");
            legalFormat_ = false;
            return;
        }
    ...
    private String key_ = null;             // front part - first base
    private String value_ = null;           // rear part - second base
