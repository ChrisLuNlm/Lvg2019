...
public class RuleResult
{
    ...
    *
    * @param  inTerm input term of the current rule result
    * @param  outTerm output term (result) of the current rule result
    * @param  ruleStr string format of rule used in the current rule result
    */
