...
/*****************************************************************************
* This class is the command line program for Norm.
*
* <p><b>History:</b>
* <ul>
* </ul>
...
public class norm extends SystemOption
{
    ...
    // main() -> Norm.ExecuteCommands: to setup flags
    // main() -> Norm.GetVariants() -> LineHandler()
        ...
        Out out)
    {
        ...
        {
            NormHelp.NormHelp(outWriter_, fileOutput_, out);
            runFlag_ = false;
        }
        ...
        else if(CheckOption(nameItem, "-v") == true)
        {
            try
            {
                String releaseStr = "norm." + GlobalBehavior.YEAR;
    ...
    private boolean filterInputFlag_ = false;  // flag for filtered input
    ...
    private RamTrie trie_ = null;         // ram Trie
