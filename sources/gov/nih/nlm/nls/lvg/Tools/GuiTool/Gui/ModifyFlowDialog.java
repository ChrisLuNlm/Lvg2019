...
/*************************************************************************
* This class show the dialog for modifying a selected flow.
...
public class ModifyFlowDialog extends JDialog
{
    private ModifyFlowDialog(JFrame owner)
    {
        ...
        helpB.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                String flowUrl = "file:" + lvgDir + "docs/designDoc/UDF/flow/"
        ...
        okB.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent evt)
            {
                ...
                LvgGlobal.cmd_.SetFlowComponent(cmd, flowIndex_); // cmd list
                setVisible(false);
            }
        });
    ...
    private static void UpdateSelectedList(int index)
    {
        ...
        String netFlowStr = flowStr.substring(3);    // strip "-f:"
        StringTokenizer buf = new StringTokenizer(netFlowStr, ":");
        // tokenize flow components from a flow
        selectedModel_.removeAllElements();
