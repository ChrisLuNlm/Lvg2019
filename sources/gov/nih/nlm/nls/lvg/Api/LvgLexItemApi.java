...
* a Vector of String of Lvg ouputs.
*
...
public class LvgLexItemApi extends LvgCmdApi
{
    ...
    *
    * @return  A Vector of lexItem - Lvg mutation results
    *
    ...
    *
    * @param  ins  A Vector of LexItem - input (from flow compoment output)
    *
    * @return  A Vector of LexItem - mutation result
    *
    ...
    * The input is a Vector of LexItems.
    *
    * @param  ins  A Vector of lexItem - inputs of LexItem
    *
    * @return  A Vector of LexItem - mutation result
    *
    * @throws SQLException if exception caught in DB
