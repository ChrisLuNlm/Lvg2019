...
* either an LexItem or a Vector of LexItem.  The output is a Vector of LexItem.
*
...
public class LvgApi
{
    ...
    *
    * @return  the maximum terms for permuting uninflection words
    */
    ...
    *
    * @return  A Vector of String - stop words list
    */
    ...
    *
    * @return  A Vector of String - non-info words list
    */
    ...
    *
    * @return  A Vector of String - conjunction words list
    */
