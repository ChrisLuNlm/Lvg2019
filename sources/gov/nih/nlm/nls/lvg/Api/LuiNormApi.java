...
public class LuiNormApi
{
    ...
    * @param ramTrieI persistent trie of inflections
    */
    ...
    *
    * @return  an LexItem with target strings are canonicalized and normalized 
    * Strings (luiNorm) 
    *
    ...
    *
    * @return  A Vector of LexItem - canonical normalized results
    *
    * @throws Exception if exception caught
    */
