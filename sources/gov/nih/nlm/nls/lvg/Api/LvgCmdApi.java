...
* this API is a term (string).  The output is a Vector of String of Lvg ouputs.
*
...
public class LvgCmdApi extends SystemOption
{
    ...
    *
    * @param   quitStrList  A Vector of String - quiting program
    */
    ...
    *
    * @throws SQLException if exception caught in DB
    * @throws IOException if exception caught in IO
    */
    ...
    */
    ...
    {
        LvgHelp.LvgHelp(outWriter_, fileOutput_, out_);
    }
    /**
    ...
    */
        ...
        Out out)
    {
        ...
        {
            LvgHelp.OutputFieldHelp(outWriter_, fileOutput_, out_);
            runFlag_ = false;
        }
        ...
        {
            LvgHelp.FlowHelp(outWriter_, fileOutput_, out_);
            runFlag_ = false;
        }
        ...
        else if(CheckOption(nameItem, "-ks:STR") == true)
        {
            lvgFlowSpecificOption_.SetSynonymFilter(
                nameItem.GetOptionArgument());
        }
    ...
    */
    protected void DefineFlag()
    {
        ...
        systemOption_.SetFlagFullName("-ks:STR", "Synonym_Source_Filter");
    ...
    */
    ...
    {
        out_.Println(outWriter_, promptStr_, fileOutput_, false);
    }
    /**
    ...
    *
    * @return A Vector of LexItem - output
    *
    * @throws SQLException if exception caught in DB
    */
        ...
        throws SQLException
    {
        ...
        {
            outs = ToSynonyms.Mutate(in, conn_, 
                lvgFlowSpecificOption_.GetSynonymFilter(), 
                detailsFlag_, mutateFlag_);
        }
        ...
        {
            outs = ToRecursiveSynonyms.Mutate(in, conn_, 
                lvgFlowSpecificOption_.GetSynonymFilter(), 
        ...
        throws SQLException, IOException
    {
        ...
        for(int flowNum = 0; flowNum < flowStrsList_.size(); flowNum++) 
        {
            ...
            // print results
            out_.Print(outWriter_, outStr, fileOutput_, toStringFlag);
        }
    }
    ...
    private void PreProcess()
    {
        ...
        for(int i = 0; i < args.size(); i++)
        {
            ...
            ExecuteCommands(io, GetOption(), out_);
    ...
    private Out out_ = new Out();    // private local variable
}
